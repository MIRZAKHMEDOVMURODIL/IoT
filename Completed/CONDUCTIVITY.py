...
# file_handler = logging.FileHandler(os.path.join(os.getcwd(), "debug.log"))
...
# logger.info("Program: " + os.path.join(os.getcwd()))
...
if rst == 0:
    ...
    for filepath in files:
        ...
        try:
            ...
            df_buff['COND_VALUES'] = df_csv["1"].astype(float) / 100000
