...
# /bin/mount -t cifs -o domain='SHGSEMNTD01',user='DBCOLL01',password='CeraColl1u' //10.21.32.72/DbStrage /IoT/ftp/mnt/share
/bin/mount -t cifs -o domain='SHGCERLDS05',user='DBCOLL01',password='CeraColl1u' //10.21.32.72/DbStrage /IoT/ftp/mnt/share
# /bin/mount -t cifs -o domain='SHGSEMNTD01',user='DBCOLL01',password='CeraColl1u' //10.21.32.70/DbStrage /IoT/ftp/mnt/share
#/bin/mount -t cifs -o user='DBCOLL01',password='CeraColl1u' //10.21.32.70/DbStrage /IoT/ftp/mnt/share
