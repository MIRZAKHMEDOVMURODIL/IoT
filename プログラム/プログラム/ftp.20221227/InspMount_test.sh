...
cp -R -u /IoT/ftp/mnt/FV04901_PC /IoT/ftp/tmp/InspDataLog /
/bin/umount /IoT/ftp/mnt/FV04901_PC
/bin/mount -t cifs -o vers=2.0,ro,user=visionsystem,password='',iocharset=utf8,uid=1002,gid=1002 //192.168.10.100/ftp_user /IoT/ftp/mnt/FV04901_PC
cp -R -u /IoT/ftp/mnt/FV04901_PC /IoT/ftp/tmp/FtpUser /
/bin/umount /IoT/ftp/mnt/FV04901_PC
/bin/mount -t cifs -o vers=2.0,ro,user=visionsystem,password='',iocharset=utf8,uid=1002,gid=1002 //192.168.10.100/daily_report /IoT/ftp/mnt/FV04901_PC
cp -R -u /IoT/ftp/mnt/FV04901_PC /IoT/ftp/tmp/DailyReport /
/bin/umount /IoT/ftp/mnt/FV04901_PC
